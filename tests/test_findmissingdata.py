...
class TestFindMissingData(unittest.TestCase):
    ...
    def test_find_missing_data(self, mock_read_csv, mock_to_csv, mock_print):
        """
        Test at findmissingdata.py leser de riktige CSV-filene og at
        utskriftsfilene 'missing_in_both.csv' og 'missing_summary.csv' blir skrevet.
        """
        ...
        # Legg til mappen 'data/processed' i sys.path slik at vi kan importere modulen
        script_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../data/processed"))
        ...
        self.assertEqual(os.path.basename(first_call_filename), "missing_in_both.csv")
        self.assertEqual(os.path.basename(second_call_filename), "missing_summary.csv")
        ...
        self.assertTrue(any("missing_in_both.csv" in line for line in printed_lines))
        self.assertTrue(any("missing_summary.csv" in line for line in printed_lines))

...
# Finn stien til mappen der denne filen ligger, for å konstruere filstier
# til CSV-filene
...
# Ekstraher datoen (YYYY-MM-DD) fra 'referenceTime'-kolonnen for enklere
# gruppering av dataene
...
# Vi ønsker å identifisere hvilke (date, timeOffset, elementId)-kombinasjoner
# som mangler i en by, sammenlignet med den andre. Dette gjøresv ed å utføre
# en full ytre join på de relevante kolonnene.

# Forbered et "slankere" datasett for Oslo ved å velge kun de relevante
...
# Utfør en full ytre join på de to "smale" DataFrames for å inkludere alle
# kombinasjoner som finnes i én by, men eventuelt mangler i den andre.
...
# Disse radene har 'oslo_value' som er NULL, mens 'tromso_value' er
# tilgjengelig.
...
# Definer filstien for CSV-filen som skal inneholde alle manglende
# målinger
...
# Ved hjelp av pandasql (sqldf) utfører vi en SQL-spørring for å telle
